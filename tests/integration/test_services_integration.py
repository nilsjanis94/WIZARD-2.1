...
from src.services.ui_state_manager import UIState, UIStateManager
...
class TestServicesIntegration:
    ...
    def test_ui_service_with_data_service(self):
        ...
        with patch.object(ui_service, "setup_fonts", return_value=True), patch.object(
            ui_service, "fix_ui_visibility"
        ):
    ...
    def test_axis_controls_integration(self):
        ...
        mock_y2_combo.setCurrentText.assert_called_once_with(
            "None"
    ...
    def test_data_processing_workflow(self, sample_tob_data):
        ...
        with patch.object(
            data_service, "process_tob_data"
        ) as mock_process, patch.object(
            data_service, "update_data_metrics"
        ) as mock_update:
    ...
    def test_error_handling_integration(self):
        ...
        with patch.object(
            ui_service, "setup_fonts", side_effect=Exception("Font error")
        ):
            try:
        ...
        with patch.object(
            data_service, "process_tob_data", side_effect=ValueError("Data error")
        ):
            try:
    ...
    def test_concurrent_service_operations(self):
        ...
        import os
        # Skip this test in headless CI environment as Qt operations may cause instability
        if os.environ.get('QT_QPA_PLATFORM') == 'offscreen':
            import pytest
            pytest.skip("Skipping Qt-dependent integration test in headless environment")
