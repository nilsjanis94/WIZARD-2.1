...
from PyQt6.QtWidgets import QApplication, QWidget, QComboBox, QLineEdit, QCheckBox
...
class TestMainWindow:
    ...
    def test_ui_state_initialization(self, qt_app):
        ...
        with patch('src.views.main_window.uic.loadUi'), \
             patch.object(MainWindow, '_store_widget_references'), \
    ...
    def test_file_dialog_handling(self, qt_app):
        ...
        with patch('src.views.main_window.uic.loadUi'), \
            ...
            with patch('src.views.main_window.QFileDialog.getOpenFileName') as mock_dialog:
    ...
    def test_project_creation(self, qt_app):
        ...
        with patch('src.views.main_window.uic.loadUi'), \
            ...
            with patch('src.views.main_window.QFileDialog.getSaveFileName') as mock_dialog:
                mock_dialog.return_value = ("new_project.wzp", "WIZARD Project Files (*.wzp)")
                
                with patch.object(window, 'project_created') as mock_signal:
                    window._on_create_project()
                    
                    # Verify signal was emitted
                    mock_signal.emit.assert_called_with("new_project.wzp", "default_password")
    ...
    def test_project_info_update(self, qt_app):
        ...
        with patch('src.views.main_window.uic.loadUi'), \
            ...
            window.location_info_label.setText.assert_called_with("Location: Test Location")
            window.location_comment_value.setText.assert_called_with("Test comment")
            window.location_sensorstring_value.setText.assert_called_with("NTC01,NTC02,PT100")
    ...
    def test_error_handling(self, qt_app):
        ...
        with patch('src.views.main_window.uic.loadUi'), \
            ...
            with patch('src.views.main_window.QFileDialog.getOpenFileName', 
