...
class TestDataService:
    ...
    def test_process_tob_data_success(self, sample_tob_data):
        ...
        with patch.object(
            service, "_get_time_range", return_value={"min": 0, "max": 5}
        ), patch.object(service, "_get_sensor_ranges", return_value={}), patch.object(
            service, "_calculate_metrics", return_value={}
        ):
