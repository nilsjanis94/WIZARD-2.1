...
class MainController:
    ...
    def _on_file_opened(self, file_path: str):
        ...
        try:
            ...
            self.error_handler.show_error("File Loading Error", f"Failed to load file: {e}")
    ...
    def _on_project_created(self, project_path: str, password: str):
        ...
        try:
            ...
            self.encryption_service.create_project(project_path, password, self.tob_data_model)
    ...
    def _on_project_opened(self, project_path: str, password: str):
        ...
        try:
            ...
            self.error_handler.show_error("Project Opening Error", f"Failed to open project: {e}")
