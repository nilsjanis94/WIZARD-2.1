...
class ErrorHandler(QObject):
    ...
    def handle_warning(self, message: str, context: Optional[str] = None,
                      parent: Optional[QWidget] = None) -> None:
        """
    ...
    def handle_info(self, message: str, context: Optional[str] = None,
                   parent: Optional[QWidget] = None) -> None:
        """
    ...
    def _show_warning_dialog(self, message: str, parent: Optional[QWidget] = None) -> None:
        """
